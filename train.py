...
from msssim_loss import MS_SSIM_L1_LOSS
# Training settings
...
parser.add_argument('--niter_decay', type=int, default=18, help='# of iter to linearly decay learning rate to zero')
...
parser.add_argument('--lamb', type=int, default=120, help='weight on L1 term in objective')
